...
export default function EditCategory({ category, categories }: Props) {
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: 'Edit', href: `/dashboard/categories/${category.slug}/edit` },
    ];
    ...
    // Parent options for select (exclude self and descendants)
    ...
    const onSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        form.post(`/dashboard/categories/${category.slug}`, {
            forceFormData: true,
            headers: {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={`Edit ${category.name_bn}`} />
