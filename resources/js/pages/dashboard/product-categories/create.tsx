...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Create', href: '/dashboard/product-categories/create' },
];

export default function CreateProductCategory({ categories }: Props) {
    const form = useForm<{
        image: File | null;
        name_bn: string;
        name_en: string;
    ...
    const onSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        form.post('/dashboard/product-categories', {
            forceFormData: true,
            onSuccess: () => {
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex flex-col gap-6">
                ...
                <div className="flex items-center justify-between">
                    <h1 className="text-2xl font-semibold">Create Product Category</h1>
