...
import { Author, Category, Post } from '@/types/models';
...
export default function EditPost({ post, categories, authors }: Props) {
    ...
    const firstPageContent = post.pages?.[0]?.content || '';
